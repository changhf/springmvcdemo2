 ...
 * @since 2017/08/22
 */
public class OssOperateUtil {
    static Logger logger = Logger.getLogger(OssOperateUtil.class);
    private static String endpoint = "http://oss-cn-shanghai.aliyuncs.com";
    private static String accessKeyId = "LTAIWTxyD2rSgFjj";
    private static String accessKeySecret = "UBzMO0mKCbTrxeXKgiBtpmsNUUjBVl";
    private static String bucketName = "bucket-test-821";
