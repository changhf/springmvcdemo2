...
public abstract class WebActionSupport {
	 ...
	 *            单个对象/集合/Map
	 * @param clazz
	 *            对象的Class，比如HashMap.class
	 * @param properties
	 *            哪些属性是需要排除的，可以通过逗号分隔或者字符串数组，如："name","age" 或者 String []strs =
	 *            {"name","age"}
	 */
    ...
    protected void returnFastJsonExcludeProperties(Object obj, String... properties) {
        if (obj != null) {
            ...
            WebUtil.returnJSON(response, com.alibaba.fastjson.JSONObject.toJSONString(obj, filter, SerializerFeature.WriteMapNullValue), "json");
        } else {
